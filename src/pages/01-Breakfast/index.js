import { Blockquote, Container, Divider, Label, Radio, Text } from "rebass";
    ...
    <div>
      <Container py={2} bg={`#e3e3e3`}>
        *WIP Notes*<br />
        ...
        <Divider />
        <Text>{props.breakfastChoice}</Text>
      </Container>
      ...
      <Container py={4}>
        <Blockquote>>> Strange animation</Blockquote>
      </Container>
...
const map = state => ({
  breakfastChoice: state.breakfastChoice
});

export default connect(map)(Breakfast);
